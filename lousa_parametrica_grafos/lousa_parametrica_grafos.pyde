"""
Grafos - Alexandre B A Villares - http://estudiohacker.io
Estudo para o Circuito Sesc 2018 (não apresentado)

Tecle 'h' para ajuda...
Exportar GIF requer a biblioteca gifAnimation, instruções na aba gif_exporter.py
"""
SKETCH_NAME = "lousa-04"  # s096 180406
...
def draw():
    ...
    global GIF_EXPORT
    if not frameCount % 15 and GIF_EXPORT:
